...
internal class ReportManagerSample
{
    ...
    {
        var reportManager = new ReportManager(amazonConnection);
        ...
        var ordersByLastUpdate =
            reportManager.GetOrdersByLastUpdate(90); //GET_FLAT_FILE_ALL_ORDERS_DATA_BY_LAST_UPDATE_GENERAL
        ...
        var UnsuppressedInventory = reportManager.GetUnsuppressedInventoryDataAsync().ConfigureAwait(false).GetAwaiter()
            .GetResult(); //GET_FBA_MYI_UNSUPPRESSED_INVENTORY_DATA
    }
}