...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Solicitations
{
    ...
    [DataContract]
    public class
        GetSolicitationActionsForOrderResponseEmbedded : IEquatable<GetSolicitationActionsForOrderResponseEmbedded>,
        IValidatableObject
    {
        /// <summary>
        ...
        public GetSolicitationActionsForOrderResponseEmbedded(List<GetSolicitationActionResponse> Actions = default)
        {
            // to ensure "Actions" is required (not null)
            if (Actions == null)
                throw new InvalidDataException(
                    "Actions is a required property for GetSolicitationActionsForOrderResponseEmbedded and cannot be null");
        ...
        {
            return Equals(input as GetSolicitationActionsForOrderResponseEmbedded);
        }
