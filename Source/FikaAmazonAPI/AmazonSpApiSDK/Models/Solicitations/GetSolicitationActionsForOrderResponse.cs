...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Solicitations
{
    ...
    /// </summary>
    [DataContract]
    public class GetSolicitationActionsForOrderResponse : IEquatable<GetSolicitationActionsForOrderResponse>,
        IValidatableObject
    {
        /// <summary>
        ...
        public GetSolicitationActionsForOrderResponse(GetSolicitationActionsForOrderResponseLinks Links = default,
            GetSolicitationActionsForOrderResponseEmbedded Embedded = default, ErrorList Errors = default)
        {
            this.Links = Links;
        ...
        {
            return Equals(input as GetSolicitationActionsForOrderResponse);
        }
