...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Solicitations
{
    ...
    /// </summary>
    [DataContract]
    public class GetSolicitationActionResponseEmbedded : IEquatable<GetSolicitationActionResponseEmbedded>,
        IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as GetSolicitationActionResponseEmbedded);
        }
