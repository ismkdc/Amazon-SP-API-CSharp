...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Solicitations
{
    ...
    /// </summary>
    [DataContract]
    public class SolicitationsAction : IEquatable<SolicitationsAction>, IValidatableObject
    {
        /// <summary>
        ...
        public SolicitationsAction(string Name = default)
        {
            ...
            if (Name == null)
                throw new InvalidDataException(
                    "Name is a required property for SolicitationsAction and cannot be null");
            this.Name = Name;
        }
