...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Messaging
{
    ...
    /// </summary>
    [DataContract]
    public class CreateDigitalAccessKeyResponse : IEquatable<CreateDigitalAccessKeyResponse>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="CreateDigitalAccessKeyResponse" /> class.
        /// </summary>
        /// <param name="errors">errors.</param>
        public CreateDigitalAccessKeyResponse(ErrorList errors = default)
        {
            Errors = errors;
        }
        ...
        {
            return Equals(input as CreateDigitalAccessKeyResponse);
        }
