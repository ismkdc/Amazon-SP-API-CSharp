...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Messaging
{
    ...
    /// </summary>
    [DataContract]
    public class GetAttributesResponse : IEquatable<GetAttributesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetAttributesResponse(Buyer buyer = default, ErrorList errors = default)
        {
            Buyer = buyer;
            Errors = errors;
        }
        ...
        {
            return Equals(input as GetAttributesResponse);
        }
