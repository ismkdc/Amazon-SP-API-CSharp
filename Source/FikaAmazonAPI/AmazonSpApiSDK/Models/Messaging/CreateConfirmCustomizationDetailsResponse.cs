...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Messaging
{
    ...
    /// </summary>
    [DataContract]
    public class CreateConfirmCustomizationDetailsResponse : IEquatable<CreateConfirmCustomizationDetailsResponse>,
        IValidatableObject
    {
        /// <summary>
        ...
        public CreateConfirmCustomizationDetailsResponse(ErrorList errors = default)
        {
            Errors = errors;
        }
        ...
        {
            return Equals(input as CreateConfirmCustomizationDetailsResponse);
        }
