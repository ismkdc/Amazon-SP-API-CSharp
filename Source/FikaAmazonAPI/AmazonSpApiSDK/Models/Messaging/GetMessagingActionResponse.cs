...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Messaging
{
    ...
    /// </summary>
    [DataContract]
    public class GetMessagingActionResponse : IEquatable<GetMessagingActionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetMessagingActionResponse(object links = default, object embedded = default,
            MessagingAction payload = default, ErrorList errors = default)
        {
            Links = links;
            Embedded = embedded;
            Payload = payload;
        ...
        {
            return Equals(input as GetMessagingActionResponse);
        }
