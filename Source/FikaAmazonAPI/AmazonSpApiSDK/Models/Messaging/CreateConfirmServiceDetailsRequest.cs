...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Messaging
{
    ...
    /// </summary>
    [DataContract]
    public class CreateConfirmServiceDetailsRequest : IEquatable<CreateConfirmServiceDetailsRequest>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="CreateConfirmServiceDetailsRequest" /> class.
        /// </summary>
        /// <param name="text">
        ///     The text to be sent to the buyer. Only links related to Home Service calls are allowed. Do not
        ...
        {
            return Equals(input as CreateConfirmServiceDetailsRequest);
        }
