...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Messaging
{
    ...
    /// </summary>
    [DataContract]
    public class CreateLegalDisclosureRequest : IEquatable<CreateLegalDisclosureRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as CreateLegalDisclosureRequest);
        }
