...
{
    /// <summary>
    ///     When a request produces a response that exceeds the &#x60;pageSize&#x60;, pagination occurs. This means the
        ...
        public bool Equals(Pagination input)
        {
            ...
            return
                ...
                (
                    ...
                    (PreviousToken != null &&
                     PreviousToken.Equals(input.PreviousToken))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (PreviousToken != null)
                    hashCode = hashCode * 59 + PreviousToken.GetHashCode();
                return hashCode;
            }
        }
    }
