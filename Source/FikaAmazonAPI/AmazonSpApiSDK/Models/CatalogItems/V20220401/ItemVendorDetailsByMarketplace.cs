...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems.V20220401
{
    ...
    /// </summary>
    [DataContract]
    public class ItemVendorDetailsByMarketplace : IEquatable<ItemVendorDetailsByMarketplace>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ReplenishmentCategoryEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "IN_SEASON")] INSEASON = 3,
            ...
            /// </summary>
            [EnumMember(Value = "NEW_PRODUCT")] NEWPRODUCT = 6,
            ...
            /// </summary>
            [EnumMember(Value = "OBSOLETE")] OBSOLETE = 9,
        ...
        public ItemVendorDetailsByMarketplace(string marketplaceId = default, string brandCode = default,
            string manufacturerCode = default, string manufacturerCodeParent = default,
            ItemVendorDetailsCategory productCategory = default, string productGroup = default,
            ItemVendorDetailsCategory productSubcategory = default,
            ReplenishmentCategoryEnum? replenishmentCategory = default)
        {
            // to ensure "marketplaceId" is required (not null)
            if (marketplaceId == null)
                throw new InvalidDataException(
                    "marketplaceId is a required property for ItemVendorDetailsByMarketplace and cannot be null");
            ...
            return
                ...
                (
                    ...
                    (ManufacturerCode != null &&
                     ManufacturerCode.Equals(input.ManufacturerCode))
                ) &&
                (
                    ManufacturerCodeParent == input.ManufacturerCodeParent ||
                    (ManufacturerCodeParent != null &&
                     ManufacturerCodeParent.Equals(input.ManufacturerCodeParent))
                ) &&
                (
                    ProductCategory == input.ProductCategory ||
                    (ProductCategory != null &&
                     ProductCategory.Equals(input.ProductCategory))
                ) &&
                (
                ...
                (
                    ProductSubcategory == input.ProductSubcategory ||
                    (ProductSubcategory != null &&
                     ProductSubcategory.Equals(input.ProductSubcategory))
                ) &&
                (
                    ReplenishmentCategory == input.ReplenishmentCategory ||
                    (ReplenishmentCategory != null &&
                     ReplenishmentCategory.Equals(input.ReplenishmentCategory))
                );
        }
        ...
        {
            return Equals(input as ItemVendorDetailsByMarketplace);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (ManufacturerCode != null)
                    hashCode = hashCode * 59 + ManufacturerCode.GetHashCode();
                if (ManufacturerCodeParent != null)
                    hashCode = hashCode * 59 + ManufacturerCodeParent.GetHashCode();
                if (ProductCategory != null)
                    hashCode = hashCode * 59 + ProductCategory.GetHashCode();
                if (ProductGroup != null)
                    hashCode = hashCode * 59 + ProductGroup.GetHashCode();
                if (ProductSubcategory != null)
                    hashCode = hashCode * 59 + ProductSubcategory.GetHashCode();
                if (ReplenishmentCategory != null)
                    hashCode = hashCode * 59 + ReplenishmentCategory.GetHashCode();
                return hashCode;
            }
        }
    }
