...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems.V20220401
{
    ...
    /// </summary>
    [DataContract]
    public class ItemVariationTheme : IEquatable<ItemVariationTheme>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="theme">
        ///     Variation theme indicating the combination of Amazon item catalog attributes that define the
        ///     variation family..
        /// </param>
        ...
        {
            return Equals(input as ItemVariationTheme);
        }
