...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems.V20220401
{
    ...
    /// </summary>
    [DataContract]
    public class ItemRelationshipsByMarketplace : IEquatable<ItemRelationshipsByMarketplace>, IValidatableObject
    {
        /// <summary>
        ...
        public ItemRelationshipsByMarketplace(string marketplaceId = default,
            List<ItemRelationship> relationships = default)
        {
            // to ensure "marketplaceId" is required (not null)
            if (marketplaceId == null)
                throw new InvalidDataException(
                    "marketplaceId is a required property for ItemRelationshipsByMarketplace and cannot be null");
            MarketplaceId = marketplaceId;
            // to ensure "relationships" is required (not null)
            if (relationships == null)
                throw new InvalidDataException(
                    "relationships is a required property for ItemRelationshipsByMarketplace and cannot be null");
        ...
        {
            return Equals(input as ItemRelationshipsByMarketplace);
        }
