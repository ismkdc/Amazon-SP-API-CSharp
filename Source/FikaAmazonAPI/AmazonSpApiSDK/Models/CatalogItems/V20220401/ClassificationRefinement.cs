...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems.V20220401
{
    ...
    /// </summary>
    [DataContract]
    public class ClassificationRefinement : IEquatable<ClassificationRefinement>, IValidatableObject
    {
        /// <summary>
        ...
        ///     (required).
        /// </param>
        public ClassificationRefinement(int? numberOfResults = default, string displayName = default,
            string classificationId = default)
        {
            // to ensure "numberOfResults" is required (not null)
            if (numberOfResults == null)
                throw new InvalidDataException(
                    "numberOfResults is a required property for ClassificationRefinement and cannot be null");
            NumberOfResults = numberOfResults;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
                throw new InvalidDataException(
                    "displayName is a required property for ClassificationRefinement and cannot be null");
            DisplayName = displayName;
            // to ensure "classificationId" is required (not null)
            if (classificationId == null)
                throw new InvalidDataException(
                    "classificationId is a required property for ClassificationRefinement and cannot be null");
        ...
        {
            return Equals(input as ClassificationRefinement);
        }
