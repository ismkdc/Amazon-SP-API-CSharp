...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems.V20220401
{
    ...
    /// </summary>
    [DataContract]
    public class ItemRelationships : List<ItemRelationshipsByMarketplace>, IEquatable<ItemRelationships>,
        IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as ItemRelationships);
        }
