...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems
{
    ...
    /// </summary>
    [DataContract]
    public class ListCatalogItemsResponse : IEquatable<ListCatalogItemsResponse>, IValidatableObject
    {
        ...
        public ListCatalogItemsResponse(ListMatchingItemsResponse Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as ListCatalogItemsResponse);
        }
