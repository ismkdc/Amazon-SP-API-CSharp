...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems
{
    ...
    ///     one for each listing condition value that is returned. Possible listing condition values are: Any, New, Used,
    ///     Collectible, Refurbished, or Club.
    /// </summary>
    [DataContract]
    public class NumberOfOfferListingsList : List<OfferListingCountType>, IEquatable<NumberOfOfferListingsList>,
        IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as NumberOfOfferListingsList);
        }
