...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.CatalogItems
{
    ...
    /// </summary>
    [DataContract]
    public class Categories : IEquatable<Categories>, IValidatableObject
    {
        /// <summary>
        ...
        public Categories(string ProductCategoryId = default, string ProductCategoryName = default,
            ...
            return
                ...
                (
                    ...
                    (ProductCategoryName != null &&
                     ProductCategoryName.Equals(input.ProductCategoryName))
                ) &&
                (
                    Parent == input.Parent ||
                    (Parent != null &&
        ...
        {
            return Equals(input as Categories);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (ProductCategoryName != null)
                    hashCode = hashCode * 59 + ProductCategoryName.GetHashCode();
                if (Parent != null)
