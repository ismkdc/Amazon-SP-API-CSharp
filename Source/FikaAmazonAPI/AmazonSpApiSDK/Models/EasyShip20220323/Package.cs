...
{
    /// <summary>
    ///     A package. This object contains all the details of the scheduled Easy Ship package including the package
    ///     identifier, physical attributes such as dimensions and weight, selected time slot to handover the package to
    ///     carrier, status of the package, and tracking/invoice details.
    /// </summary>
    [DataContract]
