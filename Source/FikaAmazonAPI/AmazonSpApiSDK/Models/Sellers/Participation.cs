...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Sellers
{
    ...
    public class Participation : IEquatable<Participation>, IValidatableObject
    {
        ...
        /// <param name="HasSuspendedListings">
        ///     Specifies if the seller has suspended listings. True if the seller Listing Status is
        ///     set to Inactive, otherwise False. (required).
        /// </param>
        public Participation(bool? IsParticipating = default, bool? HasSuspendedListings = default)
        {
            ...
            if (IsParticipating == null)
                throw new InvalidDataException(
                    "IsParticipating is a required property for Participation and cannot be null");
            this.IsParticipating = IsParticipating;
            // to ensure "HasSuspendedListings" is required (not null)
            if (HasSuspendedListings == null)
                throw new InvalidDataException(
                    "HasSuspendedListings is a required property for Participation and cannot be null");
        ...
        /// <summary>
        ///     Specifies if the seller has suspended listings. True if the seller Listing Status is set to Inactive, otherwise
        ///     False.
        /// </summary>
        /// <value>
        ///     Specifies if the seller has suspended listings. True if the seller Listing Status is set to Inactive, otherwise
            ...
            return
                (
                    ...
                    (IsParticipating != null &&
                     IsParticipating.Equals(input.IsParticipating))
                ) &&
                (
                    HasSuspendedListings == input.HasSuspendedListings ||
                    (HasSuspendedListings != null &&
                     HasSuspendedListings.Equals(input.HasSuspendedListings))
                );
        }
        ...
        {
            return Equals(input as Participation);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                var hashCode = 41;
                if (IsParticipating != null)
                    hashCode = hashCode * 59 + IsParticipating.GetHashCode();
                if (HasSuspendedListings != null)
                    hashCode = hashCode * 59 + HasSuspendedListings.GetHashCode();
                return hashCode;
            }
        }
    }
