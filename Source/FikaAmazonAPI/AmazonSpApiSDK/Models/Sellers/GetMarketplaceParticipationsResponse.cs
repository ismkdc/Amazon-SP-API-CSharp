...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Sellers
{
    ...
    /// </summary>
    [DataContract]
    public class GetMarketplaceParticipationsResponse : IEquatable<GetMarketplaceParticipationsResponse>,
        IValidatableObject
    {
        /// <summary>
        ...
        public GetMarketplaceParticipationsResponse(MarketplaceParticipationList Payload = default,
        ...
        {
            return Equals(input as GetMarketplaceParticipationsResponse);
        }
