...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FbaInbound
{
    ...
    /// </summary>
    [DataContract]
    public class GetItemEligibilityPreviewResponse : IEquatable<GetItemEligibilityPreviewResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as GetItemEligibilityPreviewResponse);
        }
