...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public class AdjustmentEventList : List<AdjustmentEvent>, IEquatable<AdjustmentEventList>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AdjustmentEventList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AdjustmentEventList()
        {
        }
        ...
        {
            return Equals(input as AdjustmentEventList);
        }
