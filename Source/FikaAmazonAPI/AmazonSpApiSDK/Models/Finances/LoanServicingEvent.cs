...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public class LoanServicingEvent : IEquatable<LoanServicingEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public LoanServicingEvent(Currency LoanAmount = default, string SourceBusinessEventType = default)
        {
        ...
        public bool Equals(LoanServicingEvent input)
        {
            ...
            return
                (
                    ...
                    (LoanAmount != null &&
                     LoanAmount.Equals(input.LoanAmount))
                ) &&
                (
                    SourceBusinessEventType == input.SourceBusinessEventType ||
                    (SourceBusinessEventType != null &&
                     SourceBusinessEventType.Equals(input.SourceBusinessEventType))
                );
        }
        ...
        {
            return Equals(input as LoanServicingEvent);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                var hashCode = 41;
                if (LoanAmount != null)
                    hashCode = hashCode * 59 + LoanAmount.GetHashCode();
                if (SourceBusinessEventType != null)
                    hashCode = hashCode * 59 + SourceBusinessEventType.GetHashCode();
                return hashCode;
            }
        }
    }
