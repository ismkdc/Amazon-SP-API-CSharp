...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public class CouponPaymentEvent : IEquatable<CouponPaymentEvent>, IValidatableObject
    {
        /// <summary>
        ...
        public CouponPaymentEvent(DateTime? PostedDate = default, string CouponId = default,
            string SellerCouponDescription = default, long? ClipOrRedemptionCount = default,
            string PaymentEventId = default, FeeComponent FeeComponent = default,
            ChargeComponent ChargeComponent = default, Currency TotalAmount = default)
        {
        ...
        public bool Equals(CouponPaymentEvent input)
        {
            ...
            return
                ...
                (
                    ...
                    (CouponId != null &&
                     CouponId.Equals(input.CouponId))
                ) &&
                (
                    SellerCouponDescription == input.SellerCouponDescription ||
                    (SellerCouponDescription != null &&
                     SellerCouponDescription.Equals(input.SellerCouponDescription))
                ) &&
                (
                    ClipOrRedemptionCount == input.ClipOrRedemptionCount ||
                    (ClipOrRedemptionCount != null &&
                     ClipOrRedemptionCount.Equals(input.ClipOrRedemptionCount))
                ) &&
                (
                    PaymentEventId == input.PaymentEventId ||
                    (PaymentEventId != null &&
                     PaymentEventId.Equals(input.PaymentEventId))
                ) &&
                (
        ...
        {
            return Equals(input as CouponPaymentEvent);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (CouponId != null)
                    hashCode = hashCode * 59 + CouponId.GetHashCode();
                if (SellerCouponDescription != null)
                    hashCode = hashCode * 59 + SellerCouponDescription.GetHashCode();
                if (ClipOrRedemptionCount != null)
                    hashCode = hashCode * 59 + ClipOrRedemptionCount.GetHashCode();
                if (PaymentEventId != null)
                    hashCode = hashCode * 59 + PaymentEventId.GetHashCode();
