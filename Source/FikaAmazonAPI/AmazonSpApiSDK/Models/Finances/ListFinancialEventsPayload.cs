...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public class ListFinancialEventsPayload : IEquatable<ListFinancialEventsPayload>, IValidatableObject
    {
        /// <summary>
        ...
        public ListFinancialEventsPayload(string NextToken = default, FinancialEvents FinancialEvents = default)
        {
            ...
            return
                ...
                (
                    ...
                    (FinancialEvents != null &&
                     FinancialEvents.Equals(input.FinancialEvents))
                );
        }
        ...
        {
            return Equals(input as ListFinancialEventsPayload);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (FinancialEvents != null)
                    hashCode = hashCode * 59 + FinancialEvents.GetHashCode();
                return hashCode;
            }
        }
    }
