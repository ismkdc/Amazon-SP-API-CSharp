...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public class DebtRecoveryEvent : IEquatable<DebtRecoveryEvent>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="DebtRecoveryEvent" /> class.
        /// </summary>
        /// <param name="DebtRecoveryType">
        ...
        public DebtRecoveryEvent(string DebtRecoveryType = default, Currency RecoveryAmount = default,
            Currency OverPaymentCredit = default, DebtRecoveryItemList DebtRecoveryItemList = default,
            ChargeInstrumentList ChargeInstrumentList = default)
        {
        ...
        public bool Equals(DebtRecoveryEvent input)
        {
            ...
            return
                (
                    DebtRecoveryType == input.DebtRecoveryType ||
                    (DebtRecoveryType != null &&
                     DebtRecoveryType.Equals(input.DebtRecoveryType))
                ) &&
                (
                ...
                (
                    OverPaymentCredit == input.OverPaymentCredit ||
                    (OverPaymentCredit != null &&
                     OverPaymentCredit.Equals(input.OverPaymentCredit))
                ) &&
                (
                    DebtRecoveryItemList == input.DebtRecoveryItemList ||
                    (DebtRecoveryItemList != null &&
                     DebtRecoveryItemList.Equals(input.DebtRecoveryItemList))
                ) &&
                (
                    ChargeInstrumentList == input.ChargeInstrumentList ||
                    (ChargeInstrumentList != null &&
                     ChargeInstrumentList.Equals(input.ChargeInstrumentList))
                );
        }
        ...
        {
            return Equals(input as DebtRecoveryEvent);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (DebtRecoveryType != null)
                    hashCode = hashCode * 59 + DebtRecoveryType.GetHashCode();
                if (RecoveryAmount != null)
                    hashCode = hashCode * 59 + RecoveryAmount.GetHashCode();
                if (OverPaymentCredit != null)
                    hashCode = hashCode * 59 + OverPaymentCredit.GetHashCode();
                if (DebtRecoveryItemList != null)
                    hashCode = hashCode * 59 + DebtRecoveryItemList.GetHashCode();
                if (ChargeInstrumentList != null)
                    hashCode = hashCode * 59 + ChargeInstrumentList.GetHashCode();
                return hashCode;
            }
        }
    }
