...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public class SolutionProviderCreditEvent : IEquatable<SolutionProviderCreditEvent>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="MarketplaceCountryCode">
        ...
        /// <param name="TransactionCreationDate">
        ///     The date and time that the credit transaction was created, in ISO 8601 date time
        ///     format..
        /// </param>
        public SolutionProviderCreditEvent(string ProviderTransactionType = default, string SellerOrderId = default,
            string MarketplaceId = default, string MarketplaceCountryCode = default, string SellerId = default,
            string SellerStoreName = default, string ProviderId = default, string ProviderStoreName = default,
            Currency TransactionAmount = default, DateTime? TransactionCreationDate = default)
        {
        ...
        public bool Equals(SolutionProviderCreditEvent input)
        {
            ...
            return
                (
                    ProviderTransactionType == input.ProviderTransactionType ||
                    (ProviderTransactionType != null &&
                     ProviderTransactionType.Equals(input.ProviderTransactionType))
                ) &&
                (
                ...
                (
                    MarketplaceCountryCode == input.MarketplaceCountryCode ||
                    (MarketplaceCountryCode != null &&
                     MarketplaceCountryCode.Equals(input.MarketplaceCountryCode))
                ) &&
                (
                ...
                (
                    ...
                    (SellerStoreName != null &&
                     SellerStoreName.Equals(input.SellerStoreName))
                ) &&
                (
                ...
                (
                    ...
                    (ProviderStoreName != null &&
                     ProviderStoreName.Equals(input.ProviderStoreName))
                ) &&
                (
                    TransactionAmount == input.TransactionAmount ||
                    (TransactionAmount != null &&
                     TransactionAmount.Equals(input.TransactionAmount))
                ) &&
                (
                    TransactionCreationDate == input.TransactionCreationDate ||
                    (TransactionCreationDate != null &&
                     TransactionCreationDate.Equals(input.TransactionCreationDate))
                );
        }
        ...
        {
            return Equals(input as SolutionProviderCreditEvent);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (ProviderTransactionType != null)
                    hashCode = hashCode * 59 + ProviderTransactionType.GetHashCode();
                ...
                if (MarketplaceCountryCode != null)
                    hashCode = hashCode * 59 + MarketplaceCountryCode.GetHashCode();
                if (SellerId != null)
                    hashCode = hashCode * 59 + SellerId.GetHashCode();
                if (SellerStoreName != null)
                    hashCode = hashCode * 59 + SellerStoreName.GetHashCode();
                if (ProviderId != null)
                    hashCode = hashCode * 59 + ProviderId.GetHashCode();
                if (ProviderStoreName != null)
                    hashCode = hashCode * 59 + ProviderStoreName.GetHashCode();
                if (TransactionAmount != null)
                    hashCode = hashCode * 59 + TransactionAmount.GetHashCode();
                if (TransactionCreationDate != null)
                    hashCode = hashCode * 59 + TransactionCreationDate.GetHashCode();
                return hashCode;
            }
        }
    }
