...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public class FeeComponent : IEquatable<FeeComponent>, IValidatableObject
    {
        /// <summary>
        ...
        public FeeComponent(string FeeType = default, Currency FeeAmount = default)
        {
        ...
        {
            return Equals(input as FeeComponent);
        }
