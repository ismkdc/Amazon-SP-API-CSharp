...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Finances
{
    ...
    /// </summary>
    [DataContract]
    public class ImagingServicesFeeEvent : IEquatable<ImagingServicesFeeEvent>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="ASIN">
        ///     The Amazon Standard Identification Number (ASIN) of the item for which the imaging service was
        ///     requested..
        /// </param>
        ...
        public ImagingServicesFeeEvent(string ImagingRequestBillingItemID = default, string ASIN = default,
            DateTime? PostedDate = default, FeeComponentList FeeList = default)
        {
        ...
        public bool Equals(ImagingServicesFeeEvent input)
        {
            ...
            return
                (
                    ImagingRequestBillingItemID == input.ImagingRequestBillingItemID ||
                    (ImagingRequestBillingItemID != null &&
                     ImagingRequestBillingItemID.Equals(input.ImagingRequestBillingItemID))
                ) &&
                (
                    ASIN == input.ASIN ||
                    (ASIN != null &&
        ...
        {
            return Equals(input as ImagingServicesFeeEvent);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (ImagingRequestBillingItemID != null)
                    hashCode = hashCode * 59 + ImagingRequestBillingItemID.GetHashCode();
                if (ASIN != null)
