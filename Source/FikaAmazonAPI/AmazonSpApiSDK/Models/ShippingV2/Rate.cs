...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ShippingV2
{
  ...
  [DataContract]
    public class Rate
    {
      ...
      /// <summary>
      ///     When true, indicates that additional inputs are required to purchase this shipment service. You must then call the
      ///     getAdditionalInputs operation to return the JSON schema to use when providing the additional inputs to the
