...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ShippingV2
{
  ...
  [DataContract]
    public class Item
    {
      ...
      /// <summary>
      ///     A list of unique serial numbers in an Amazon package that can be used to guarantee non-fraudulent items. The number
      ///     of serial numbers in the list must be less than or equal to the quantity of items being shipped. Only applicable
      ///     when channel source is Amazon.
      /// </summary>
      /// <value>
