...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ShippingV2
{
  ...
  [DataContract]
    public class DirectFulfillmentItemIdentifiers
    {
      ...
      /// <summary>
      ///     A unique identifier for an item provided by the client for a direct fulfillment shipment. This is only populated if
      ///     a single line item has multiple pieces. Defaults to 1.
      /// </summary>
      /// <value>
      ///     A unique identifier for an item provided by the client for a direct fulfillment shipment. This is only populated
