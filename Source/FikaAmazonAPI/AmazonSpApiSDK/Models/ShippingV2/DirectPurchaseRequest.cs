...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ShippingV2
{
  ...
  [DataContract]
    ...
    {
      /// <summary>
      ///     The address where the shipment will be delivered. For vendor orders, shipTo information is pulled directly from the
      ///     Amazon order.
      /// </summary>
      /// <value>
      ///     The address where the shipment will be delivered. For vendor orders, shipTo information is pulled directly from
      ///     the Amazon order.
      /// </value>
      ...
      /// <summary>
      ///     The document (label) specifications requested. The default label returned is PNG DPI 203 4x6 if no label
      ///     specification is provided. Requesting an invalid file format results in a failure.
      /// </summary>
      /// <value>
      ///     The document (label) specifications requested. The default label returned is PNG DPI 203 4x6 if no label
      ///     specification is provided. Requesting an invalid file format results in a failure.
