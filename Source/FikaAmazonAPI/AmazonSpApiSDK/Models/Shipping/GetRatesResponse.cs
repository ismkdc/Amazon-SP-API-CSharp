...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Shipping
{
    ...
    /// </summary>
    [DataContract]
    public class GetRatesResponse : IEquatable<GetRatesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetRatesResponse(GetRatesResult Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as GetRatesResponse);
        }
