...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Shipping
{
    ...
    /// </summary>
    [DataContract]
    public class RetrieveShippingLabelResponse : IEquatable<RetrieveShippingLabelResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as RetrieveShippingLabelResponse);
        }
