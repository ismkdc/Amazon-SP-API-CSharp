...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Shipping
{
    ...
    /// </summary>
    [DataContract]
    public class ServiceRate : IEquatable<ServiceRate>, IValidatableObject
    {
        /// <summary>
        ...
        public ServiceRate(Currency TotalCharge = default, Weight BillableWeight = default,
            ServiceType ServiceType = default, ShippingPromiseSet Promise = default)
        {
            ...
            if (BillableWeight == null)
                throw new InvalidDataException(
                    "BillableWeight is a required property for ServiceRate and cannot be null");
        ...
        public bool Equals(ServiceRate input)
        {
            ...
            return
                ...
                (
                    BillableWeight == input.BillableWeight ||
                    (BillableWeight != null &&
                     BillableWeight.Equals(input.BillableWeight))
                ) &&
                (
        ...
        {
            return Equals(input as ServiceRate);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (BillableWeight != null)
                    hashCode = hashCode * 59 + BillableWeight.GetHashCode();
                if (ServiceType != null)
