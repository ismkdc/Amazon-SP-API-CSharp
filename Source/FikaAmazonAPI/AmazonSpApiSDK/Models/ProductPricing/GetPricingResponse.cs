...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ProductPricing
{
    ...
    /// </summary>
    [DataContract]
    public class GetPricingResponse : IEquatable<GetPricingResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetPricingResponse(PriceList Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as GetPricingResponse);
        }
