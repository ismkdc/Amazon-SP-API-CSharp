...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ProductPricing
{
    ...
    /// </summary>
    [DataContract]
    public class OfferListingCountType : IEquatable<OfferListingCountType>, IValidatableObject
    {
        /// <summary>
        ...
        public OfferListingCountType(int? Count = default, string Condition = default)
        {
            // to ensure "Count" is required (not null)
            if (Count == null)
                throw new InvalidDataException(
                    "Count is a required property for OfferListingCountType and cannot be null");
            this.Count = Count;
            // to ensure "Condition" is required (not null)
            if (Condition == null)
                throw new InvalidDataException(
                    "Condition is a required property for OfferListingCountType and cannot be null");
        ...
        {
            return Equals(input as OfferListingCountType);
        }
