...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Notifications
{
    ...
    /// </summary>
    [DataContract]
    public class CreateSubscriptionResponse : IEquatable<CreateSubscriptionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateSubscriptionResponse(Subscription Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as CreateSubscriptionResponse);
        }
