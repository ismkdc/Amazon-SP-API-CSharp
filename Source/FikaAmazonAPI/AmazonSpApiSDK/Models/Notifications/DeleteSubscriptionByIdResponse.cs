...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Notifications
{
    ...
    /// </summary>
    [DataContract]
    public class DeleteSubscriptionByIdResponse : IEquatable<DeleteSubscriptionByIdResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as DeleteSubscriptionByIdResponse);
        }
