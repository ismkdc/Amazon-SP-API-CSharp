...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Notifications
{
    ...
    /// </summary>
    [DataContract]
    public class GetDestinationsResponse : IEquatable<GetDestinationsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetDestinationsResponse(DestinationList Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as GetDestinationsResponse);
        }
