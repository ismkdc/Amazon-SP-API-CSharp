...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Notifications
{
    ...
    /// </summary>
    [DataContract]
    public class GetDestinationResponse : IEquatable<GetDestinationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetDestinationResponse(Destination Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as GetDestinationResponse);
        }
