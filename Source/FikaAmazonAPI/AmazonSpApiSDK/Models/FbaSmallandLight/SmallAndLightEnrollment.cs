...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FbaSmallandLight
{
    ...
    /// </summary>
    [DataContract]
    public class SmallAndLightEnrollment : IEquatable<SmallAndLightEnrollment>, IValidatableObject
    {
        /// <summary>
        ...
        public SmallAndLightEnrollment(string MarketplaceId = default, string SellerSKU = default,
            SmallAndLightEnrollmentStatus Status = default)
        {
            // to ensure "MarketplaceId" is required (not null)
            if (MarketplaceId == null)
                throw new InvalidDataException(
                    "MarketplaceId is a required property for SmallAndLightEnrollment and cannot be null");
            this.MarketplaceId = MarketplaceId;
            // to ensure "SellerSKU" is required (not null)
            if (SellerSKU == null)
                throw new InvalidDataException(
                    "SellerSKU is a required property for SmallAndLightEnrollment and cannot be null");
            this.SellerSKU = SellerSKU;
            // to ensure "Status" is required (not null)
            if (Status == null)
                throw new InvalidDataException(
                    "Status is a required property for SmallAndLightEnrollment and cannot be null");
            this.Status = Status;
        }
        ...
        {
            return Equals(input as SmallAndLightEnrollment);
        }
