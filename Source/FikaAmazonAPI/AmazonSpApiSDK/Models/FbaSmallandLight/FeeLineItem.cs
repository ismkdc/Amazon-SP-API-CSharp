...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FbaSmallandLight
{
    ...
    /// </summary>
    [DataContract]
    public class FeeLineItem : IEquatable<FeeLineItem>, IValidatableObject
    {
        /// <summary>
        ...
        public enum FeeTypeEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "Commission")] Commission = 4
        }
        ...
        public FeeLineItem(FeeTypeEnum FeeType = default, MoneyType FeeCharge = default)
        {
        ...
        public bool Equals(FeeLineItem input)
        {
            ...
            return
                ...
                (
                    FeeCharge == input.FeeCharge ||
                    (FeeCharge != null &&
                     FeeCharge.Equals(input.FeeCharge))
                );
        }
        ...
        {
            return Equals(input as FeeLineItem);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (FeeCharge != null)
                    hashCode = hashCode * 59 + FeeCharge.GetHashCode();
                return hashCode;
            }
        }
    }
