...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ProductFees
{
    ...
    /// </summary>
    [DataContract]
    public class FeesEstimate : IEquatable<FeesEstimate>, IValidatableObject
    {
        /// <summary>
        ...
        ///     Initializes a new instance of the <see cref="FeesEstimate" /> class.
        /// </summary>
        /// <param name="TimeOfFeesEstimation">
        ///     The time for which the fees were estimated. This defaults to the time the request is
        ///     made. (required).
        /// </param>
        ...
        public FeesEstimate(DateTime? TimeOfFeesEstimation = default, MoneyType TotalFeesEstimate = default,
            FeeDetailList FeeDetailList = default)
        {
            // to ensure "TimeOfFeesEstimation" is required (not null)
            if (TimeOfFeesEstimation == null)
                throw new InvalidDataException(
                    "TimeOfFeesEstimation is a required property for FeesEstimate and cannot be null");
        ...
        public bool Equals(FeesEstimate input)
        {
            ...
            return
                (
                    TimeOfFeesEstimation == input.TimeOfFeesEstimation ||
                    (TimeOfFeesEstimation != null &&
                     TimeOfFeesEstimation.Equals(input.TimeOfFeesEstimation))
                ) &&
                (
                    TotalFeesEstimate == input.TotalFeesEstimate ||
                    (TotalFeesEstimate != null &&
                     TotalFeesEstimate.Equals(input.TotalFeesEstimate))
                ) &&
                (
                    FeeDetailList == input.FeeDetailList ||
                    (FeeDetailList != null &&
                     FeeDetailList.Equals(input.FeeDetailList))
                );
        }
        ...
        {
            return Equals(input as FeesEstimate);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                var hashCode = 41;
                if (TimeOfFeesEstimation != null)
                    hashCode = hashCode * 59 + TimeOfFeesEstimation.GetHashCode();
                if (TotalFeesEstimate != null)
                    hashCode = hashCode * 59 + TotalFeesEstimate.GetHashCode();
                if (FeeDetailList != null)
                    hashCode = hashCode * 59 + FeeDetailList.GetHashCode();
                return hashCode;
            }
        }
    }
