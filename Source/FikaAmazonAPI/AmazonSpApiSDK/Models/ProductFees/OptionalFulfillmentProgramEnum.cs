...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ProductFees
{
    ...
    public enum OptionalFulfillmentProgramEnum
    {
        ...
        /// </summary>
        [EnumMember(Value = "FBA_CORE")] FBA_CORE,

        /// <summary>
        ///     Returns the FBA Small and Light (SNL) fees for the offer. The SNL program offers reduced fulfillment costs on
        ///     qualified items. To check item eligibility for the SNL program, use the getSmallAndLightEligibilityBySellerSKU
        ///     operation of the FBA Small And Light API.
        /// </summary>
        [EnumMember(Value = "FBA_SNL")] FBA_SNL,

        /// <summary>
        ///     Returns the cross-border European Fulfillment Network fees across EU countries for the offer.
        /// </summary>
        [EnumMember(Value = "FBA_EFN")] FBA_EFN
    }
}