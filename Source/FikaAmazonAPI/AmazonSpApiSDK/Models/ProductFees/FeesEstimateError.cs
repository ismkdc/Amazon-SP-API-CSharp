...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ProductFees
{
    ...
    /// </summary>
    [DataContract]
    public class FeesEstimateError : IEquatable<FeesEstimateError>, IValidatableObject
    {
        /// <summary>
        ...
        public FeesEstimateError(string Type = default, string Code = default, string Message = default,
            FeesEstimateErrorDetail Detail = default)
        {
            ...
            if (Message == null)
                throw new InvalidDataException(
                    "Message is a required property for FeesEstimateError and cannot be null");
            this.Message = Message;
            // to ensure "Detail" is required (not null)
            if (Detail == null)
                throw new InvalidDataException(
                    "Detail is a required property for FeesEstimateError and cannot be null");
            this.Detail = Detail;
        }
        ...
        {
            return Equals(input as FeesEstimateError);
        }
