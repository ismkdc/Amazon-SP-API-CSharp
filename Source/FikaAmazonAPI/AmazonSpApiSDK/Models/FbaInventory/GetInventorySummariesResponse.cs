...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FbaInventory
{
    ...
    /// </summary>
    [DataContract]
    public class GetInventorySummariesResponse : IEquatable<GetInventorySummariesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetInventorySummariesResponse(GetInventorySummariesResult Payload = default,
            Pagination Pagination = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as GetInventorySummariesResponse);
        }
