...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    public enum FulfillmentOrderStatus
    {
        ...
        /// </summary>
        [EnumMember(Value = "Received")] Received = 2,

        /// <summary>
        ///     Enum Planning for value: Planning
        /// </summary>
        [EnumMember(Value = "Planning")] Planning = 3,

        /// <summary>
        ///     Enum Processing for value: Processing
        /// </summary>
        [EnumMember(Value = "Processing")] Processing = 4,
        ...
        /// </summary>
        [EnumMember(Value = "Complete")] Complete = 6,
        ...
        /// </summary>
        [EnumMember(Value = "Unfulfillable")] Unfulfillable = 8,

        /// <summary>
        ///     Enum Invalid for value: Invalid
        /// </summary>
        [EnumMember(Value = "Invalid")] Invalid = 9
    }
}