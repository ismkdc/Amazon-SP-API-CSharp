...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    /// </summary>
    [DataContract]
    public class CancelFulfillmentOrderResponse : IEquatable<CancelFulfillmentOrderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CancelFulfillmentOrderResponse(ErrorList Errors = default)
        {
            this.Errors = Errors;
        }
        ...
        {
            return Equals(input as CancelFulfillmentOrderResponse);
        }
