...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    /// </summary>
    [DataContract]
    public class UpdateFulfillmentOrderResponse : IEquatable<UpdateFulfillmentOrderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as UpdateFulfillmentOrderResponse);
        }
