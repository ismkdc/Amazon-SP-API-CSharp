...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    /// </summary>
    [DataContract]
    public class FeatureSku : IEquatable<FeatureSku>, IValidatableObject
    {
        /// <summary>
        ...
        public FeatureSku(string sellerSku = default, string fnSku = default, string asin = default,
            decimal? skuCount = default, List<string> overlappingSkus = default)
        {
            SellerSku = sellerSku;
            FnSku = fnSku;
            Asin = asin;
        ...
        public bool Equals(FeatureSku input)
        {
            ...
            return
                ...
                (
                    ...
                    (SkuCount != null &&
                     SkuCount.Equals(input.SkuCount))
                ) &&
                (
                    OverlappingSkus == input.OverlappingSkus ||
                    (OverlappingSkus != null &&
                     OverlappingSkus.SequenceEqual(input.OverlappingSkus))
                );
        }
        ...
        {
            return Equals(input as FeatureSku);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (SkuCount != null)
                    hashCode = hashCode * 59 + SkuCount.GetHashCode();
                if (OverlappingSkus != null)
                    hashCode = hashCode * 59 + OverlappingSkus.GetHashCode();
                return hashCode;
            }
        }
    }
