...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    /// </summary>
    [DataContract]
    public class CreateFulfillmentOrderResponse : IEquatable<CreateFulfillmentOrderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as CreateFulfillmentOrderResponse);
        }
