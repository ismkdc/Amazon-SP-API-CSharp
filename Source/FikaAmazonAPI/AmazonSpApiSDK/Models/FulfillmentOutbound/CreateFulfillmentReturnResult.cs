...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    /// </summary>
    [DataContract]
    public class CreateFulfillmentReturnResult : IEquatable<CreateFulfillmentReturnResult>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateFulfillmentReturnResult(ReturnItemList ReturnItemList = default,
            InvalidReturnItemList InvalidReturnItemList = default,
            ReturnAuthorizationList ReturnAuthorizationList = default)
        {
        ...
        public bool Equals(CreateFulfillmentReturnResult input)
        {
            ...
            return
                (
                    ReturnItemList == input.ReturnItemList ||
                    (ReturnItemList != null &&
                     ReturnItemList.Equals(input.ReturnItemList))
                ) &&
                (
                    InvalidReturnItemList == input.InvalidReturnItemList ||
                    (InvalidReturnItemList != null &&
                     InvalidReturnItemList.Equals(input.InvalidReturnItemList))
                ) &&
                (
                    ReturnAuthorizationList == input.ReturnAuthorizationList ||
                    (ReturnAuthorizationList != null &&
                     ReturnAuthorizationList.Equals(input.ReturnAuthorizationList))
                );
        }
        ...
        {
            return Equals(input as CreateFulfillmentReturnResult);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (ReturnItemList != null)
                    hashCode = hashCode * 59 + ReturnItemList.GetHashCode();
                if (InvalidReturnItemList != null)
                    hashCode = hashCode * 59 + InvalidReturnItemList.GetHashCode();
                if (ReturnAuthorizationList != null)
                    hashCode = hashCode * 59 + ReturnAuthorizationList.GetHashCode();
                return hashCode;
            }
        }
    }
