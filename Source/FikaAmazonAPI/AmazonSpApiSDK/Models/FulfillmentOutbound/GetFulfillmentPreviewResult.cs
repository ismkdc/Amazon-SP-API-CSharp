...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    /// </summary>
    [DataContract]
    public class GetFulfillmentPreviewResult : IEquatable<GetFulfillmentPreviewResult>, IValidatableObject
    {
        /// <summary>
        ...
        public bool Equals(GetFulfillmentPreviewResult input)
        {
            ...
            return
                FulfillmentPreviews == input.FulfillmentPreviews ||
                (FulfillmentPreviews != null &&
                 FulfillmentPreviews.Equals(input.FulfillmentPreviews));
        }
        ...
        {
            return Equals(input as GetFulfillmentPreviewResult);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (FulfillmentPreviews != null)
                    hashCode = hashCode * 59 + FulfillmentPreviews.GetHashCode();
                return hashCode;
            }
        }
    }
