...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentOutbound
{
    ...
    /// </summary>
    [DataContract]
    public class ListReturnReasonCodesResult : IEquatable<ListReturnReasonCodesResult>, IValidatableObject
    {
        /// <summary>
        ...
        public ListReturnReasonCodesResult(ReasonCodeDetailsList ReasonCodeDetailsList = default)
        {
        ...
        public bool Equals(ListReturnReasonCodesResult input)
        {
            ...
            return
                ReasonCodeDetailsList == input.ReasonCodeDetailsList ||
                (ReasonCodeDetailsList != null &&
                 ReasonCodeDetailsList.Equals(input.ReasonCodeDetailsList));
        }
        ...
        {
            return Equals(input as ListReturnReasonCodesResult);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (ReasonCodeDetailsList != null)
                    hashCode = hashCode * 59 + ReasonCodeDetailsList.GetHashCode();
                return hashCode;
            }
        }
    }
