...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public class InvalidSKU : IEquatable<InvalidSKU>, IValidatableObject
    {
        /// <summary>
        ...
        public InvalidSKU(string sellerSKU = default, ErrorReason? errorReason = default)
        {
            SellerSKU = sellerSKU;
        ...
        {
            return Equals(input as InvalidSKU);
        }
