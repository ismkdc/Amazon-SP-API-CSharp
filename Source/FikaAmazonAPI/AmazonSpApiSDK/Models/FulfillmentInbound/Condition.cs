...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    public enum Condition
    {
        ...
        /// </summary>
        [EnumMember(Value = "NewItem")] NewItem = 1,
        ...
        /// </summary>
        [EnumMember(Value = "NewOEM")] NewOEM = 3,

        /// <summary>
        ///     Enum NewOpenBox for value: NewOpenBox
        /// </summary>
        [EnumMember(Value = "NewOpenBox")] NewOpenBox = 4,

        /// <summary>
        ///     Enum UsedLikeNew for value: UsedLikeNew
        /// </summary>
        [EnumMember(Value = "UsedLikeNew")] UsedLikeNew = 5,

        /// <summary>
        ///     Enum UsedVeryGood for value: UsedVeryGood
        /// </summary>
        [EnumMember(Value = "UsedVeryGood")] UsedVeryGood = 6,

        /// <summary>
        ///     Enum UsedGood for value: UsedGood
        /// </summary>
        [EnumMember(Value = "UsedGood")] UsedGood = 7,

        /// <summary>
        ///     Enum UsedAcceptable for value: UsedAcceptable
        /// </summary>
        [EnumMember(Value = "UsedAcceptable")] UsedAcceptable = 8,

        /// <summary>
        ///     Enum UsedPoor for value: UsedPoor
        /// </summary>
        [EnumMember(Value = "UsedPoor")] UsedPoor = 9,
        ...
        /// </summary>
        [EnumMember(Value = "Refurbished")] Refurbished = 17,

        /// <summary>
        ///     Enum Club for value: Club
        /// </summary>
        [EnumMember(Value = "Club")] Club = 18
    }
}