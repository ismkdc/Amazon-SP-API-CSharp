...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public class GetLabelsResponse : IEquatable<GetLabelsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetLabelsResponse(LabelDownloadURL payload = default, ErrorList errors = default)
        {
            Payload = payload;
            Errors = errors;
        }
        ...
        {
            return Equals(input as GetLabelsResponse);
        }
