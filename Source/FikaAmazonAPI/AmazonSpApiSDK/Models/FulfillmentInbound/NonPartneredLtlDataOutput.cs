...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public class NonPartneredLtlDataOutput : IEquatable<NonPartneredLtlDataOutput>, IValidatableObject
    {
        /// <summary>
        ...
        public NonPartneredLtlDataOutput(string carrierName = default, string proNumber = default)
        {
            // to ensure "carrierName" is required (not null)
            if (carrierName == null)
                throw new InvalidDataException(
                    "carrierName is a required property for NonPartneredLtlDataOutput and cannot be null");
            CarrierName = carrierName;
            // to ensure "proNumber" is required (not null)
            if (proNumber == null)
                throw new InvalidDataException(
                    "proNumber is a required property for NonPartneredLtlDataOutput and cannot be null");
            ProNumber = proNumber;
        }
        ...
        public bool Equals(NonPartneredLtlDataOutput input)
        {
            ...
            return
                ...
                (
                    ...
                    (ProNumber != null &&
                     ProNumber.Equals(input.ProNumber))
                );
        }
        ...
        {
            return Equals(input as NonPartneredLtlDataOutput);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (ProNumber != null)
                    hashCode = hashCode * 59 + ProNumber.GetHashCode();
                return hashCode;
            }
        }
    }
