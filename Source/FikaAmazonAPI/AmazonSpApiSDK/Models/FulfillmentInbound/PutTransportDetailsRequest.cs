...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public class PutTransportDetailsRequest : IEquatable<PutTransportDetailsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="transportDetails">
        ///     Information required to create an Amazon-partnered carrier shipping estimate, or to
        ///     alert the Amazon fulfillment center to the arrival of an inbound shipment by a non-Amazon-partnered carrier.
        ///     (required).
        /// </param>
        public PutTransportDetailsRequest(bool? isPartnered = default, ShipmentType shipmentType = default,
            TransportDetailInput transportDetails = default)
        {
            // to ensure "isPartnered" is required (not null)
            if (isPartnered == null)
                throw new InvalidDataException(
                    "isPartnered is a required property for PutTransportDetailsRequest and cannot be null");
            IsPartnered = isPartnered;
            // to ensure "shipmentType" is required (not null)
            if (shipmentType == null)
                throw new InvalidDataException(
                    "shipmentType is a required property for PutTransportDetailsRequest and cannot be null");
            ShipmentType = shipmentType;
            // to ensure "transportDetails" is required (not null)
            if (transportDetails == null)
                throw new InvalidDataException(
                    "transportDetails is a required property for PutTransportDetailsRequest and cannot be null");
        ...
        {
            return Equals(input as PutTransportDetailsRequest);
        }
