...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public class PrepDetails : IEquatable<PrepDetails>, IValidatableObject
    {
        /// <summary>
        ...
        public PrepDetails(PrepInstruction prepInstruction = default, PrepOwner prepOwner = default)
        {
            // to ensure "prepInstruction" is required (not null)
            if (prepInstruction == null)
                throw new InvalidDataException(
                    "prepInstruction is a required property for PrepDetails and cannot be null");
        ...
        public bool Equals(PrepDetails input)
        {
            ...
            return
                ...
                (
                    ...
                    (PrepOwner != null &&
                     PrepOwner.Equals(input.PrepOwner))
                );
        }
        ...
        {
            return Equals(input as PrepDetails);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (PrepOwner != null)
                    hashCode = hashCode * 59 + PrepOwner.GetHashCode();
                return hashCode;
            }
        }
    }
