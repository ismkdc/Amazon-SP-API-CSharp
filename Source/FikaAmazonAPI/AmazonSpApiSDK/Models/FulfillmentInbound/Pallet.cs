...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public class Pallet : IEquatable<Pallet>, IValidatableObject
    {
        /// <summary>
        ...
        ///     The dimensions of the pallet. Length and width must be 40 inches by 48 inches. Height must be
        ///     less than or equal to 60 inches. (required).
        /// </param>
        ...
        public Pallet(Dimensions dimensions = default, Weight weight = default, bool? isStacked = default)
        {
        ...
        /// <summary>
        ///     The dimensions of the pallet. Length and width must be 40 inches by 48 inches. Height must be less than or equal to
        ///     60 inches.
        /// </summary>
        /// <value>
        ///     The dimensions of the pallet. Length and width must be 40 inches by 48 inches. Height must be less than or equal
        ///     to 60 inches.
        /// </value>
        ...
        public bool Equals(Pallet input)
        {
            ...
            return
                ...
                (
                    ...
                    (IsStacked != null &&
                     IsStacked.Equals(input.IsStacked))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (IsStacked != null)
                    hashCode = hashCode * 59 + IsStacked.GetHashCode();
                return hashCode;
            }
        }
    }
