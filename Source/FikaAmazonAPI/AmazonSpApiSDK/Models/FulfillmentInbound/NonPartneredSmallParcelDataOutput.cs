...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public class NonPartneredSmallParcelDataOutput : IEquatable<NonPartneredSmallParcelDataOutput>, IValidatableObject
    {
        /// <summary>
        ...
        public NonPartneredSmallParcelDataOutput(NonPartneredSmallParcelPackageOutputList packageList = default)
        {
            // to ensure "packageList" is required (not null)
            if (packageList == null)
                throw new InvalidDataException(
                    "packageList is a required property for NonPartneredSmallParcelDataOutput and cannot be null");
        ...
        {
            return Equals(input as NonPartneredSmallParcelDataOutput);
        }
