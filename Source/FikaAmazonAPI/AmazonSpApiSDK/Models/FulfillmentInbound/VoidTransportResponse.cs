...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    /// </summary>
    [DataContract]
    public class VoidTransportResponse : IEquatable<VoidTransportResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public VoidTransportResponse(CommonTransportResult payload = default, ErrorList errors = default)
        {
            Payload = payload;
            Errors = errors;
        }
        ...
        {
            return Equals(input as VoidTransportResponse);
        }
