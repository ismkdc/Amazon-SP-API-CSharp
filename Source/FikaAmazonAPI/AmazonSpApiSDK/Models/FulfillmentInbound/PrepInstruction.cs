...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    public enum PrepInstruction
    {
        ...
        /// </summary>
        [EnumMember(Value = "Polybagging")] Polybagging = 1,

        /// <summary>
        ///     Enum BubbleWrapping for value: BubbleWrapping
        /// </summary>
        [EnumMember(Value = "BubbleWrapping")] BubbleWrapping = 2,

        /// <summary>
        ///     Enum Taping for value: Taping
        /// </summary>
        [EnumMember(Value = "Taping")] Taping = 3,
        ...
        /// </summary>
        [EnumMember(Value = "Labeling")] Labeling = 5,

        /// <summary>
        ///     Enum HangGarment for value: HangGarment
        /// </summary>
        [EnumMember(Value = "HangGarment")] HangGarment = 6,

        /// <summary>
        ///     Enum SetCreation for value: SetCreation
        /// </summary>
        [EnumMember(Value = "SetCreation")] SetCreation = 7,

        /// <summary>
        ///     Enum Boxing for value: Boxing
        /// </summary>
        [EnumMember(Value = "Boxing")] Boxing = 8,
        ...
        /// </summary>
        [EnumMember(Value = "Debundle")] Debundle = 10,
        ...
        /// </summary>
        [EnumMember(Value = "CapSealing")] CapSealing = 12,

        /// <summary>
        ///     Enum SetStickering for value: SetStickering
        /// </summary>
        [EnumMember(Value = "SetStickering")] SetStickering = 13,
        ...
        /// </summary>
        [EnumMember(Value = "NoPrep")] NoPrep = 15
    }
}