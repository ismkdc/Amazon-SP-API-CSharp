...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    public enum PackageStatus
    {
        ...
        /// </summary>
        [EnumMember(Value = "SHIPPED")] SHIPPED = 1,

        /// <summary>
        ///     Enum INTRANSIT for value: IN_TRANSIT
        /// </summary>
        [EnumMember(Value = "IN_TRANSIT")] INTRANSIT = 2,
        ...
        /// </summary>
        [EnumMember(Value = "CHECKED_IN")] CHECKEDIN = 4,

        /// <summary>
        ///     Enum RECEIVING for value: RECEIVING
        /// </summary>
        [EnumMember(Value = "RECEIVING")] RECEIVING = 5,
