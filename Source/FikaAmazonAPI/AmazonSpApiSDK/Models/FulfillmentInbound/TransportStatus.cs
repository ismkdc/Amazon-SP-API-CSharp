...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.FulfillmentInbound
{
    ...
    public enum TransportStatus
    {
        ...
        /// </summary>
        [EnumMember(Value = "ESTIMATING")] ESTIMATING = 2,

        /// <summary>
        ///     Enum ESTIMATED for value: ESTIMATED
        /// </summary>
        [EnumMember(Value = "ESTIMATED")] ESTIMATED = 3,
        ...
        /// </summary>
        [EnumMember(Value = "CONFIRMING")] CONFIRMING = 5,

        /// <summary>
        ///     Enum CONFIRMED for value: CONFIRMED
        /// </summary>
        [EnumMember(Value = "CONFIRMED")] CONFIRMED = 6,
        ...
        /// </summary>
        [EnumMember(Value = "VOIDING")] VOIDING = 8,

        /// <summary>
        ///     Enum VOIDED for value: VOIDED
        /// </summary>
        [EnumMember(Value = "VOIDED")] VOIDED = 9,
        ...
        /// </summary>
        [EnumMember(Value = "ERROR")] ERROR = 11
    }
}