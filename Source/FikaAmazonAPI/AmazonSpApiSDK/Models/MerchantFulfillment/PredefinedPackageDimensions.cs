...
{
    /// <summary>
    ///     An enumeration of predefined parcel tokens. If you specify a PredefinedPackageDimensions token, you are not
    ///     obligated to use a branded package from a carrier. For example, if you specify the FedEx_Box_10kg token, you do not
    ///     have to use that particular package from FedEx. You are only obligated to use a box that matches the dimensions
    ///     specified by the token.  Note: Please note that carriers can have restrictions on the type of package allowed for
    ///     certain ship methods. Check the carrier website for all details. Example: Flat rate pricing is available when
    ///     materials are sent by USPS in a USPS-produced Flat Rate Envelope or Box.
    /// </summary>
    /// <value>
    ///     An enumeration of predefined parcel tokens. If you specify a PredefinedPackageDimensions token, you are not
    ///     obligated to use a branded package from a carrier. For example, if you specify the FedEx_Box_10kg token, you do not
    ...
    public enum PredefinedPackageDimensions
    {
        ...
        /// </summary>
        [EnumMember(Value = "FedEx_Box_10kg")] FedExBox10kg = 1,

        /// <summary>
        ///     Enum FedExBox25kg for value: FedEx_Box_25kg
        /// </summary>
        [EnumMember(Value = "FedEx_Box_25kg")] FedExBox25kg = 2,
        ...
        /// </summary>
        [EnumMember(Value = "FedEx_Envelope")] FedExEnvelope = 11,
        ...
        /// </summary>
        [EnumMember(Value = "FedEx_Pak_1")] FedExPak1 = 13,

        /// <summary>
        ///     Enum FedExPak2 for value: FedEx_Pak_2
        /// </summary>
        [EnumMember(Value = "FedEx_Pak_2")] FedExPak2 = 14,

        /// <summary>
        ///     Enum FedExTube for value: FedEx_Tube
        /// </summary>
        [EnumMember(Value = "FedEx_Tube")] FedExTube = 15,

        /// <summary>
        ///     Enum FedExXLPak for value: FedEx_XL_Pak
        /// </summary>
        [EnumMember(Value = "FedEx_XL_Pak")] FedExXLPak = 16,

        /// <summary>
        ///     Enum UPSBox10kg for value: UPS_Box_10kg
        /// </summary>
        [EnumMember(Value = "UPS_Box_10kg")] UPSBox10kg = 17,

        /// <summary>
        ///     Enum UPSBox25kg for value: UPS_Box_25kg
        /// </summary>
        [EnumMember(Value = "UPS_Box_25kg")] UPSBox25kg = 18,
        ...
        /// </summary>
        [EnumMember(Value = "UPS_Pad_Pak")] UPSPadPak = 29,

        /// <summary>
        ///     Enum UPSPallet for value: UPS_Pallet
        /// </summary>
        [EnumMember(Value = "UPS_Pallet")] UPSPallet = 30,

        /// <summary>
        ///     Enum USPSCard for value: USPS_Card
        /// </summary>
        [EnumMember(Value = "USPS_Card")] USPSCard = 31,

        /// <summary>
        ///     Enum USPSFlat for value: USPS_Flat
        /// </summary>
        [EnumMember(Value = "USPS_Flat")] USPSFlat = 32,
        ...
        /// </summary>
        [EnumMember(Value = "USPS_Letter")] USPSLetter = 41,
