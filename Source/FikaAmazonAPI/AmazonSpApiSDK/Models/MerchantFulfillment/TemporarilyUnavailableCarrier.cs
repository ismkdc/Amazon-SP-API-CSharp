...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.MerchantFulfillment
{
    ...
    /// </summary>
    [DataContract]
    public class TemporarilyUnavailableCarrier : IEquatable<TemporarilyUnavailableCarrier>, IValidatableObject
    {
        /// <summary>
        ...
        public TemporarilyUnavailableCarrier(string carrierName = default)
        {
            ...
            if (carrierName == null)
                throw new InvalidDataException(
                    "carrierName is a required property for TemporarilyUnavailableCarrier and cannot be null");
        ...
        {
            return Equals(input as TemporarilyUnavailableCarrier);
        }
