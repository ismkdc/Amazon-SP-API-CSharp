...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ListingsItems
{
    ...
    /// </summary>
    [DataContract]
    public class ItemProcurement : IEquatable<ItemProcurement>, IValidatableObject
    {
        /// <summary>
        ...
        public ItemProcurement(Money costPrice = default)
        {
            ...
            if (costPrice == null)
                throw new InvalidDataException(
                    "costPrice is a required property for ItemProcurement and cannot be null");
            CostPrice = costPrice;
        }
        ...
        public bool Equals(ItemProcurement input)
        {
            ...
            return
                ...
                (CostPrice != null &&
                 CostPrice.Equals(input.CostPrice));
        }
        ...
        {
            return Equals(input as ItemProcurement);
        }
