...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Services
{
    ...
    /// </summary>
    [DataContract]
    public class ServiceJobProvider : IEquatable<ServiceJobProvider>, IValidatableObject
    {
        /// <summary>
        ...
        public bool Equals(ServiceJobProvider input)
        {
            ...
            return
                ServiceJobProviderId == input.ServiceJobProviderId ||
                (ServiceJobProviderId != null &&
                 ServiceJobProviderId.Equals(input.ServiceJobProviderId));
        }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            var regexServiceJobProviderId = new Regex(@"^[A-Z0-9]*$", RegexOptions.CultureInvariant);
            if (false == regexServiceJobProviderId.Match(ServiceJobProviderId).Success)
                yield return new ValidationResult(
                    "Invalid value for ServiceJobProviderId, must match a pattern of " + regexServiceJobProviderId,
                    new[] { "ServiceJobProviderId" });
        }
        ...
        {
            return Equals(input as ServiceJobProvider);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (ServiceJobProviderId != null)
                    hashCode = hashCode * 59 + ServiceJobProviderId.GetHashCode();
                return hashCode;
            }
        }
    }
