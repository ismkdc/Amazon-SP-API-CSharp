...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Services
{
    ...
    /// </summary>
    [DataContract]
    public class AppointmentTime : IEquatable<AppointmentTime>, IValidatableObject
    {
        /// <summary>
        ...
        public AppointmentTime(DateTime? StartTime = default, int? DurationInMinutes = default)
        {
            ...
            if (StartTime == null)
                throw new InvalidDataException(
                    "StartTime is a required property for AppointmentTime and cannot be null");
            this.StartTime = StartTime;
            // to ensure "DurationInMinutes" is required (not null)
            if (DurationInMinutes == null)
                throw new InvalidDataException(
                    "DurationInMinutes is a required property for AppointmentTime and cannot be null");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (DurationInMinutes < 1)
                yield return new ValidationResult(
                    "Invalid value for DurationInMinutes, must be a value greater than or equal to 1.",
        ...
        {
            return Equals(input as AppointmentTime);
        }
