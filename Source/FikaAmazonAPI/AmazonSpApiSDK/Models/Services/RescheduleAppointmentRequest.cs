...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Services
{
    ...
    /// </summary>
    [DataContract]
    public class RescheduleAppointmentRequest : IEquatable<RescheduleAppointmentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public RescheduleAppointmentRequest(AppointmentTimeInput AppointmentTime = default,
            RescheduleReasonCode RescheduleReasonCode = default)
        {
            // to ensure "AppointmentTime" is required (not null)
            if (AppointmentTime == null)
                throw new InvalidDataException(
                    "AppointmentTime is a required property for RescheduleAppointmentRequest and cannot be null");
            this.AppointmentTime = AppointmentTime;
            // to ensure "RescheduleReasonCode" is required (not null)
            if (RescheduleReasonCode == null)
                throw new InvalidDataException(
                    "RescheduleReasonCode is a required property for RescheduleAppointmentRequest and cannot be null");
        ...
        public bool Equals(RescheduleAppointmentRequest input)
        {
            ...
            return
                ...
                (
                    RescheduleReasonCode == input.RescheduleReasonCode ||
                    (RescheduleReasonCode != null &&
                     RescheduleReasonCode.Equals(input.RescheduleReasonCode))
                );
        }
        ...
        {
            return Equals(input as RescheduleAppointmentRequest);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (RescheduleReasonCode != null)
                    hashCode = hashCode * 59 + RescheduleReasonCode.GetHashCode();
                return hashCode;
            }
        }
    }
