...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Services
{
    ...
    /// </summary>
    [DataContract]
    public class GetServiceJobByServiceJobIdResponse : IEquatable<GetServiceJobByServiceJobIdResponse>,
        IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as GetServiceJobByServiceJobIdResponse);
        }
