...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Services
{
    ...
    /// </summary>
    [DataContract]
    public class ServiceLocation : IEquatable<ServiceLocation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ServiceLocationTypeEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "IN_HOME")] INHOME = 1,

            /// <summary>
            ///     Enum INSTORE for value: IN_STORE
            /// </summary>
            [EnumMember(Value = "IN_STORE")] INSTORE = 2,

            /// <summary>
            ///     Enum ONLINE for value: ONLINE
            /// </summary>
            [EnumMember(Value = "ONLINE")] ONLINE = 3
        }
            ...
            return
                (
                    ...
                    (ServiceLocationType != null &&
                     ServiceLocationType.Equals(input.ServiceLocationType))
                ) &&
                (
        ...
        {
            return Equals(input as ServiceLocation);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = 41;
                if (ServiceLocationType != null)
                    hashCode = hashCode * 59 + ServiceLocationType.GetHashCode();
                if (Address != null)
