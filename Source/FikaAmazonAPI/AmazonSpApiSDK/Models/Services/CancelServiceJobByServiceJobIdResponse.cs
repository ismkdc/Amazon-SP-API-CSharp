...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Services
{
    ...
    /// </summary>
    [DataContract]
    public class CancelServiceJobByServiceJobIdResponse : IEquatable<CancelServiceJobByServiceJobIdResponse>,
        IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as CancelServiceJobByServiceJobIdResponse);
        }
