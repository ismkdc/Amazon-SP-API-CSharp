...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Reports
{
    ...
    /// </summary>
    [DataContract]
    public class CreateReportResponse : IEquatable<CreateReportResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateReportResponse(CreateReportResult Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as CreateReportResponse);
        }
