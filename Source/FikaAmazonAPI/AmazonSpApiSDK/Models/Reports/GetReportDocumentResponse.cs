...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Reports
{
    ...
    /// </summary>
    [DataContract]
    public class GetReportDocumentResponse : IEquatable<GetReportDocumentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetReportDocumentResponse(ReportDocument Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as GetReportDocumentResponse);
        }
