...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Reports
{
    ...
    /// </summary>
    [DataContract]
    public class ReportSchedule : IEquatable<ReportSchedule>, IValidatableObject
    {
        /// <summary>
        ...
        ///     time format..
        /// </param>
        public ReportSchedule(string ReportScheduleId = default, string ReportType = default,
            List<string> MarketplaceIds = default, ReportOptions ReportOptions = default, string Period = default,
            DateTime? NextReportCreationTime = default)
        {
            // to ensure "ReportScheduleId" is required (not null)
            if (ReportScheduleId == null)
                throw new InvalidDataException(
                    "ReportScheduleId is a required property for ReportSchedule and cannot be null");
            this.ReportScheduleId = ReportScheduleId;
            // to ensure "ReportType" is required (not null)
            if (ReportType == null)
                throw new InvalidDataException(
                    "ReportType is a required property for ReportSchedule and cannot be null");
        ...
        {
            return Equals(input as ReportSchedule);
        }
