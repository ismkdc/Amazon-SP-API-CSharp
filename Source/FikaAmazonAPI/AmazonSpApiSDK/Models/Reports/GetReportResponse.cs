...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Reports
{
    ...
    /// </summary>
    [DataContract]
    public class GetReportResponse : IEquatable<GetReportResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetReportResponse(Report Payload = default, ErrorList Errors = default)
        {
        ...
        {
            return Equals(input as GetReportResponse);
        }
