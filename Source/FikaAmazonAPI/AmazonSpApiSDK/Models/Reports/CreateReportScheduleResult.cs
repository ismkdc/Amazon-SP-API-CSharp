...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Reports
{
    ...
    /// </summary>
    [DataContract]
    public class CreateReportScheduleResult : IEquatable<CreateReportScheduleResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// </param>
        public CreateReportScheduleResult(string ReportScheduleId = default)
        {
            // to ensure "ReportScheduleId" is required (not null)
            if (ReportScheduleId == null)
                throw new InvalidDataException(
                    "ReportScheduleId is a required property for CreateReportScheduleResult and cannot be null");
        ...
        {
            return Equals(input as CreateReportScheduleResult);
        }
