...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Feeds
{
    ...
    /// </summary>
    [DataContract]
    public class GetFeedsResponse : IEquatable<GetFeedsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetFeedsResponse(FeedList Payload = default, string NextToken = default, ErrorList Errors = default)
        {
