...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class GetOrderItemsResponse : IEquatable<GetOrderItemsResponse>, IValidatableObject
    {
        ...
        public GetOrderItemsResponse(OrderItemsList payload = default, ErrorList errors = default)
        {
            Payload = payload;
            Errors = errors;
        }
        ...
        {
            return Equals(input as GetOrderItemsResponse);
        }
