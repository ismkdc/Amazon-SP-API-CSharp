...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class PaymentExecutionDetailItemList : List<PaymentExecutionDetailItem>,
        IEquatable<PaymentExecutionDetailItemList>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return Equals(input as PaymentExecutionDetailItemList);
        }
