...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class OrderApprovalsResponse : IEquatable<OrderApprovalsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public OrderApprovalsResponse(string nextToken = default,
            List<OrderItemApprovals> orderItemsApprovalsList = default)
        {
            // to ensure "orderItemsApprovalsList" is required (not null)
            if (orderItemsApprovalsList == null)
                throw new InvalidDataException(
                    "orderItemsApprovalsList is a required property for OrderApprovalsResponse and cannot be null");
            OrderItemsApprovalsList = orderItemsApprovalsList;
            NextToken = nextToken;
        }
        ...
        public bool Equals(OrderApprovalsResponse input)
        {
            ...
            return
                ...
                (
                    OrderItemsApprovalsList == input.OrderItemsApprovalsList ||
                    OrderItemsApprovalsList != null
                );
        }
        ...
        {
            return Equals(input as OrderApprovalsResponse);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (OrderItemsApprovalsList != null)
                    hashCode = hashCode * 59 + OrderItemsApprovalsList.GetHashCode();
                return hashCode;
            }
        }
    }
