...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class ProductInfoDetail : IEquatable<ProductInfoDetail>, IValidatableObject
    {
        ...
        public ProductInfoDetail(int? numberOfItems = default)
        {
        ...
        {
            return Equals(input as ProductInfoDetail);
        }
