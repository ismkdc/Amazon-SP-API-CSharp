...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class OrderBuyerInfo : IEquatable<OrderBuyerInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// </param>
        public OrderBuyerInfo(string amazonOrderId = default, string buyerEmail = default, string buyerName = default,
            string buyerCounty = default, BuyerTaxInfo buyerTaxInfo = default, string purchaseOrderNumber = default)
        {
            // to ensure "amazonOrderId" is required (not null)
            if (amazonOrderId == null)
                throw new InvalidDataException(
                    "amazonOrderId is a required property for OrderBuyerInfo and cannot be null");
        ...
        {
            return Equals(input as OrderBuyerInfo);
        }
