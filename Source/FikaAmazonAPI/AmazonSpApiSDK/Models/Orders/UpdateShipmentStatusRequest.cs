...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class UpdateShipmentStatusRequest : IEquatable<UpdateShipmentStatusRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateShipmentStatusRequest(string marketplaceId = default, ShipmentStatus shipmentStatus = default,
            OrderItems orderItems = default)
        {
            // to ensure "marketplaceId" is required (not null)
            if (marketplaceId == null)
                throw new InvalidDataException(
                    "marketplaceId is a required property for UpdateShipmentStatusRequest and cannot be null");
            MarketplaceId = marketplaceId;
            // to ensure "shipmentStatus" is required (not null)
            if (shipmentStatus == null)
                throw new InvalidDataException(
                    "shipmentStatus is a required property for UpdateShipmentStatusRequest and cannot be null");
        ...
        {
            return Equals(input as UpdateShipmentStatusRequest);
        }
