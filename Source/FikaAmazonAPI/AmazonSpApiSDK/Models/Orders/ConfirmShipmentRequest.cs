...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class ConfirmShipmentRequest : IEquatable<ConfirmShipmentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public enum CodCollectionMethodEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "DirectPayment")] DirectPayment = 1
        }
        ...
        public ConfirmShipmentRequest(PackageDetail packageDetail = default,
            CodCollectionMethodEnum? codCollectionMethod = default, string marketplaceId = default)
        {
            // to ensure "packageDetail" is required (not null)
            if (packageDetail == null)
                throw new InvalidDataException(
                    "packageDetail is a required property for ConfirmShipmentRequest and cannot be null");
            PackageDetail = packageDetail;
            // to ensure "marketplaceId" is required (not null)
            if (marketplaceId == null)
                throw new InvalidDataException(
                    "marketplaceId is a required property for ConfirmShipmentRequest and cannot be null");
        ...
        public bool Equals(ConfirmShipmentRequest input)
        {
            ...
            return
                (
                    ...
                    (PackageDetail != null &&
                     PackageDetail.Equals(input.PackageDetail))
                ) &&
                (
                    CodCollectionMethod == input.CodCollectionMethod ||
                    (CodCollectionMethod != null &&
                     CodCollectionMethod.Equals(input.CodCollectionMethod))
                ) &&
                (
        ...
        {
            return Equals(input as ConfirmShipmentRequest);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                var hashCode = 41;
                if (PackageDetail != null)
                    hashCode = hashCode * 59 + PackageDetail.GetHashCode();
                if (CodCollectionMethod != null)
                    hashCode = hashCode * 59 + CodCollectionMethod.GetHashCode();
                if (MarketplaceId != null)
