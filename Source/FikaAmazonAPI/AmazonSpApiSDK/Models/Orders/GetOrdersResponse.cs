...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class GetOrdersResponse : IEquatable<GetOrdersResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetOrdersResponse(OrdersList payload = default, ErrorList errors = default)
        {
            Payload = payload;
            Errors = errors;
        }
        ...
        {
            return Equals(input as GetOrdersResponse);
        }
