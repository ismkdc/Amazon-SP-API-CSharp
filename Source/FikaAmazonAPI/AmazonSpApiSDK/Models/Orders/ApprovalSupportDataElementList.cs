...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public class ApprovalSupportDataElementList : List<ApprovalSupportDataElement>,
        IEquatable<ApprovalSupportDataElementList>, IValidatableObject
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ApprovalSupportDataElementList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ApprovalSupportDataElementList()
        {
        }
        ...
        {
            return Equals(input as ApprovalSupportDataElementList);
        }
