...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorOrders
{
    ...
    /// </summary>
    [DataContract]
    public class GetPurchaseOrderResponse : IEquatable<GetPurchaseOrderResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetPurchaseOrderResponse(Order payload = default, ErrorList errors = default)
        {
            Payload = payload;
            Errors = errors;
        }
        ...
        {
            return Equals(input as GetPurchaseOrderResponse);
        }
