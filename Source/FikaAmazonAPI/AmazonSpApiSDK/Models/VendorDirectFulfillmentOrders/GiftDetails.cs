...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorDirectFulfillmentOrders
{
    ...
    /// </summary>
    [DataContract]
    public class GiftDetails : IEquatable<GiftDetails>, IValidatableObject
    {
        /// <summary>
        ...
        public bool Equals(GiftDetails input)
        {
            ...
            return
                ...
                (
                    GiftWrapId == input.GiftWrapId ||
                    (GiftWrapId != null &&
                     GiftWrapId.Equals(input.GiftWrapId))
                );
        }
        ...
        {
            return Equals(input as GiftDetails);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (GiftWrapId != null)
                    hashCode = hashCode * 59 + GiftWrapId.GetHashCode();
                return hashCode;
            }
        }
    }
