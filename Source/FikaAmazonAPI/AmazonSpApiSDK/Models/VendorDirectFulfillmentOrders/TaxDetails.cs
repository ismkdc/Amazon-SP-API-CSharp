...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorDirectFulfillmentOrders
{
    ...
    /// </summary>
    [DataContract]
    public class TaxDetails : IEquatable<TaxDetails>, IValidatableObject
    {
        /// <summary>
        ///     Tax type.
        /// </summary>
        ...
        public enum TypeEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "CONSUMPTION")] CONSUMPTION = 1,
            ...
            /// </summary>
            [EnumMember(Value = "MwSt.")] MwSt = 3,

            /// <summary>
            ///     Enum PST for value: PST
            /// </summary>
            [EnumMember(Value = "PST")] PST = 4,

            /// <summary>
            ///     Enum TOTAL for value: TOTAL
            /// </summary>
            [EnumMember(Value = "TOTAL")] TOTAL = 5,

            /// <summary>
            ///     Enum TVA for value: TVA
            /// </summary>
            [EnumMember(Value = "TVA")] TVA = 6,

            /// <summary>
            ///     Enum VAT for value: VAT
            /// </summary>
            [EnumMember(Value = "VAT")] VAT = 7
        }
        ...
        public TaxDetails(string taxRate = default, Money taxAmount = default, Money taxableAmount = default,
        ...
        {
            return Equals(input as TaxDetails);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (TaxableAmount != null)
                    hashCode = hashCode * 59 + TaxableAmount.GetHashCode();
                if (Type != null)
