...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorDirectFulfillmentOrders
{
    ...
    public class OrderAcknowledgementItem : IEquatable<OrderAcknowledgementItem>, IValidatableObject
    {
        ...
        /// <param name="acknowledgementDate">
        ///     The date and time when the order is acknowledged, in ISO-8601 date/time format. For
        ///     example: 2018-07-16T23:00:00Z / 2018-07-16T23:00:00-05:00 / 2018-07-16T23:00:00-08:00. (required).
        /// </param>
        ...
        public OrderAcknowledgementItem(string purchaseOrderNumber = default, string vendorOrderNumber = default,
            DateTime? acknowledgementDate = default, AcknowledgementStatus acknowledgementStatus = default,
            PartyIdentification sellingParty = default, PartyIdentification shipFromParty = default,
            List<OrderItemAcknowledgement> itemAcknowledgements = default)
        {
            // to ensure "purchaseOrderNumber" is required (not null)
            if (purchaseOrderNumber == null)
                throw new InvalidDataException(
                    "purchaseOrderNumber is a required property for OrderAcknowledgementItem and cannot be null");
            PurchaseOrderNumber = purchaseOrderNumber;
            // to ensure "vendorOrderNumber" is required (not null)
            if (vendorOrderNumber == null)
                throw new InvalidDataException(
                    "vendorOrderNumber is a required property for OrderAcknowledgementItem and cannot be null");
            VendorOrderNumber = vendorOrderNumber;
            // to ensure "acknowledgementDate" is required (not null)
            if (acknowledgementDate == null)
                throw new InvalidDataException(
                    "acknowledgementDate is a required property for OrderAcknowledgementItem and cannot be null");
            AcknowledgementDate = acknowledgementDate;
            // to ensure "acknowledgementStatus" is required (not null)
            if (acknowledgementStatus == null)
                throw new InvalidDataException(
                    "acknowledgementStatus is a required property for OrderAcknowledgementItem and cannot be null");
            AcknowledgementStatus = acknowledgementStatus;
            // to ensure "sellingParty" is required (not null)
            if (sellingParty == null)
                throw new InvalidDataException(
                    "sellingParty is a required property for OrderAcknowledgementItem and cannot be null");
            SellingParty = sellingParty;
            // to ensure "shipFromParty" is required (not null)
            if (shipFromParty == null)
                throw new InvalidDataException(
                    "shipFromParty is a required property for OrderAcknowledgementItem and cannot be null");
        ...
        /// </summary>
        /// <value>
        ///     The date and time when the order is acknowledged, in ISO-8601 date/time format. For example:
            ...
            return
                ...
                (
                    ...
                    (VendorOrderNumber != null &&
                     VendorOrderNumber.Equals(input.VendorOrderNumber))
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (VendorOrderNumber != null)
                    hashCode = hashCode * 59 + VendorOrderNumber.GetHashCode();
                if (AcknowledgementDate != null)
