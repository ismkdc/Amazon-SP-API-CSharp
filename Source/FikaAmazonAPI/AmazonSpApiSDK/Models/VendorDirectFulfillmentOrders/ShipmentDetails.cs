...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorDirectFulfillmentOrders
{
    ...
    public class ShipmentDetails : IEquatable<ShipmentDetails>, IValidatableObject
    {
        ...
        ///     Ship method to be used for shipping the order. Amazon defines ship method codes indicating the
        ///     shipping carrier and shipment service level. To see the full list of ship methods in use, including both the code
        ///     and the friendly name, search the &#39;Help&#39; section on Vendor Central for &#39;ship methods&#39;. (required).
        /// </param>
        ...
        public ShipmentDetails(bool? isPriorityShipment = default, bool? isScheduledDeliveryShipment = default,
            bool? isPslipRequired = default, bool? isGift = default, string shipMethod = default,
            ShipmentDates shipmentDates = default, string messageToCustomer = default)
        {
            // to ensure "isPriorityShipment" is required (not null)
            if (isPriorityShipment == null)
                throw new InvalidDataException(
                    "isPriorityShipment is a required property for ShipmentDetails and cannot be null");
            IsPriorityShipment = isPriorityShipment;
            // to ensure "isPslipRequired" is required (not null)
            if (isPslipRequired == null)
                throw new InvalidDataException(
                    "isPslipRequired is a required property for ShipmentDetails and cannot be null");
            IsPslipRequired = isPslipRequired;
            // to ensure "shipMethod" is required (not null)
            if (shipMethod == null)
                throw new InvalidDataException(
                    "shipMethod is a required property for ShipmentDetails and cannot be null");
            ShipMethod = shipMethod;
            // to ensure "shipmentDates" is required (not null)
            if (shipmentDates == null)
                throw new InvalidDataException(
                    "shipmentDates is a required property for ShipmentDetails and cannot be null");
            ShipmentDates = shipmentDates;
            // to ensure "messageToCustomer" is required (not null)
            if (messageToCustomer == null)
                throw new InvalidDataException(
                    "messageToCustomer is a required property for ShipmentDetails and cannot be null");
        ...
        /// <summary>
        ///     Ship method to be used for shipping the order. Amazon defines ship method codes indicating the shipping carrier and
        ///     shipment service level. To see the full list of ship methods in use, including both the code and the friendly name,
        ///     search the &#39;Help&#39; section on Vendor Central for &#39;ship methods&#39;.
        /// </summary>
        /// <value>
            ...
            return
                (
                    ...
                    (IsPriorityShipment != null &&
                     IsPriorityShipment.Equals(input.IsPriorityShipment))
                ) &&
                (
                    IsScheduledDeliveryShipment == input.IsScheduledDeliveryShipment ||
                    (IsScheduledDeliveryShipment != null &&
                     IsScheduledDeliveryShipment.Equals(input.IsScheduledDeliveryShipment))
                ) &&
                (
                    IsPslipRequired == input.IsPslipRequired ||
                    (IsPslipRequired != null &&
                     IsPslipRequired.Equals(input.IsPslipRequired))
                ) &&
                (
                    IsGift == input.IsGift ||
                    (IsGift != null &&
                ...
                (
                    ...
                    (ShipMethod != null &&
                     ShipMethod.Equals(input.ShipMethod))
                ) &&
                (
                    ShipmentDates == input.ShipmentDates ||
                    (ShipmentDates != null &&
                     ShipmentDates.Equals(input.ShipmentDates))
                ) &&
                (
                    MessageToCustomer == input.MessageToCustomer ||
                    (MessageToCustomer != null &&
                     MessageToCustomer.Equals(input.MessageToCustomer))
                );
        }
        ...
        {
            return Equals(input as ShipmentDetails);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                var hashCode = 41;
                if (IsPriorityShipment != null)
                    hashCode = hashCode * 59 + IsPriorityShipment.GetHashCode();
                if (IsScheduledDeliveryShipment != null)
                    hashCode = hashCode * 59 + IsScheduledDeliveryShipment.GetHashCode();
                if (IsPslipRequired != null)
                    hashCode = hashCode * 59 + IsPslipRequired.GetHashCode();
                if (IsGift != null)
                    hashCode = hashCode * 59 + IsGift.GetHashCode();
                if (ShipMethod != null)
                    hashCode = hashCode * 59 + ShipMethod.GetHashCode();
                if (ShipmentDates != null)
                    hashCode = hashCode * 59 + ShipmentDates.GetHashCode();
                if (MessageToCustomer != null)
                    hashCode = hashCode * 59 + MessageToCustomer.GetHashCode();
                return hashCode;
            }
        }
    }
