...
namespace FikaAmazonAPI.NotificationMessages
{
    ...
    public abstract class OfferBase
    {
        ...
        /// <summary>
        ///     Required. The subcondition of the item. For example: New, Mint, Very Good, Good, Acceptable, Poor, Club, OEM,
        ...
        /// <summary>
        ///     Optional. Information about the seller's feedback, including the percentage of positive feedback, and the total
        ...
        /// <summary>
        ///     Optional. Indicates whether the offer is currently in the Buy Box. There can be up to two Buy Box winners at any
        ///     time per ASIN, one that is eligible for Prime and one that is not eligible for Prime.
        /// </summary>
