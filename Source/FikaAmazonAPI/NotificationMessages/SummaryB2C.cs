...
namespace FikaAmazonAPI.NotificationMessages
{
    public class SummaryB2C : SummaryBase
    {
        ...
        /// <summary>
        ///     Optional. The suggested lower price of the item, including shipping (minus Amazon Points). The suggested lower
        ///     price is based on a range of factors, including historical selling prices, recent Buy Box-eligible prices, and
        ///     input from customers for your products.
        /// </summary>
        ...
        /// <summary>
        ///     Required. A list that contains the total number of offers that are eligible for the Buy Box for the given
        ...
        /// <summary>
        ///     Optional. This price is based on competitive prices from other retailers (excluding other Amazon sellers). Your
        ///     offer may be ineligible for the Buy Box if your price + shipping is greater than this competitive price.
        /// </summary>
