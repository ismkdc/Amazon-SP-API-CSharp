...
namespace FikaAmazonAPI.NotificationMessages
{
    ...
    {
        /// <summary>
        ///     Required. A list that contains the lowest prices of the item for the given conditions, fulfillment channels,
        ...
        /// <summary>
        ///     Optional. A list that contains the Buy Box price of the item for the given conditions, quantity tiers, and discount
        ///     types.
        /// </summary>
        /// <remarks>
