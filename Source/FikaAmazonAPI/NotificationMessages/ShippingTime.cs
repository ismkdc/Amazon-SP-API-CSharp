...
namespace FikaAmazonAPI.NotificationMessages
{
    ...
    public class ShippingTime
    {
        ...
        /// <summary>
        ///     Optional. The date when the item will be available for shipping. Only displayed for items that are not currently
        ...
        /// <summary>
        ///     Optional. Indicates whether the item is available for shipping now, or on a known or an unknown date in the future.
