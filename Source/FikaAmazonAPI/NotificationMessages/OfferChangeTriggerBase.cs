...
namespace FikaAmazonAPI.NotificationMessages
{
    ...
    public abstract class OfferChangeTriggerBase
    {
        ...
        /// <summary>
        ///     Required. The condition of the item that had an offer change. For example, if a used offer changes, the array of
        ///     offers in the Offers object will be only used items. The Summary object provides a summary for the other conditions
        ///     that can be used for repricing.
        /// </summary>
