...
namespace FikaAmazonAPI.Parameter.Restrictions
{
    public class ParameterGetListingsRestrictions : ParameterBased
    {
        ...
        /// <summary>
        ///     A locale for reason text localization. When not provided, the default language code of the first marketplace is
        ///     used. Examples: "en_US", "fr_CA", "fr_FR". Localized messages default to "en_US" when a localization is not
