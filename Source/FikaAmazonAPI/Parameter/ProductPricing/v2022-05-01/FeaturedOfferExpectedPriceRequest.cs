...
namespace FikaAmazonAPI.Parameter.ProductPricing.v2022_05_01
{
    ...
    {
        /// <summary>
        ///     The URI associated with an individual request within a batch. For FeaturedOfferExpectedPrice, this should be
        ///     '/products/pricing/2022-05-01/offer/featuredOfferExpectedPrice'.
        /// </summary>
        [JsonProperty("uri")]
        public string Uri => ApiUrls.ProductPricingApiUrls.FeaturedOfferExpectedPriceUri;
