...
namespace FikaAmazonAPI.Parameter.ProductPricing
{
    public class ListingOffersRequest
    {
        ...
        /// </summary>
        [JsonProperty("uri")]
        public string Uri => ProductPricingApiUrls.GetListingOffers(QueryParams.SellerSKU);
        ...
        [JsonProperty("queryParams")] public ParameterGetListingOffers QueryParams { get; set; }
    }
}