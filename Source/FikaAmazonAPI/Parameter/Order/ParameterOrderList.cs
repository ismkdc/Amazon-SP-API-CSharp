...
namespace FikaAmazonAPI.Parameter.Order
{
    ...
    {
        /// <summary>
        ///     A date used for selecting orders created after (or at) a specified time. Only orders placed after the specified
        ///     time are returned. Either the CreatedAfter parameter or the LastUpdatedAfter parameter is required. Both cannot be
        ///     empty. The date must be in ISO 8601 format.
        /// </summary>
        ...
        /// <summary>
        ///     A date used for selecting orders that were last updated after (or at) a specified time. An update is defined as any
        ...
        ///     seller. The date must be in ISO 8601 format.
        /// </summary>
        ...
        /// <summary>
        ///     A list of MarketplaceId values. Used to select orders that were placed in the specified marketplaces. Max count :
        ///     50
        /// </summary>
        ...
        /// <summary>
        ///     A list of AmazonOrderId values. An AmazonOrderId is an Amazon-defined order identifier, in 3-7-7 format. Max count
        ///     : 50
        /// </summary>
        ...
        /// <summary>
        ///     An order identifier that is specified by the seller. Used to select only the orders that match the order
        ///     identifier. If SellerOrderId is specified, then FulfillmentChannels, OrderStatuses, PaymentMethod,
