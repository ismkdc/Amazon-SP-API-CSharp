...
namespace FikaAmazonAPI.ReportGeneration
{
    public class ProductsReport
    {
        public ProductsReport(string path, Encoding encoding = default)
        {
            ...
            var values = new List<ProductsRow>();
            foreach (var row in table.Rows) values.Add(ProductsRow.FromRow(row));
            Data = values;
        }
    ...
    public class ProductsRow
    {
        ...
        /// <summary>
        ///     An identifier created by Amazon when you create a listing. Consists of 4 digits, a capital letter and 6 more
        ///     digits.
        /// </summary>
        ...
        /// <summary>
        ///     A numeric entry that indicates if the product-id is an ASIN, ISBN, UPC or EAN code/number. When uploading files in
        ///     Standard Book format, this field value will default to 2 (ISBN) unless otherwise specified.
        ...
        public static ProductsRow FromRow(TableRow rowData)
        {
            ...
            row.FulfillmentChannel =
                rowData.GetString("fulfillment-channel") ?? rowData.GetString("fulfilment-channel");
