...
namespace FikaAmazonAPI.ReportGeneration
{
    public class DataConverter
    {
        ...
        {
            if (decimal.TryParse(str?.Replace(",", "."), NumberStyles.Any, new CultureInfo("en-US"), out var value))
                return value;
            return null;
        }
        ...
        {
            if (int.TryParse(str?.Replace(",", "."), NumberStyles.Integer, new CultureInfo("en-US"),
        ...
        {
            if (double.TryParse(str?.Replace(",", "."), NumberStyles.Any, new CultureInfo("en-US"), out var value))
                return value;
            return null;
        }
